...
var _originalDir = "temp";
var _originalUrl = "temp";
    ...
    UploadHandler.prototype.post = function () {
        ...
        form
            ...
            .on('field', function (name, value) {
                if (name == 'username') {
                    if(_originalDir == "temp"){
                        _originalDir = options.uploadDir();
                    }
                    options.uploadDir = function(){
                        return _originalDir + "/" + (value ? value : "noUser");
                    };
                    if(_originalUrl == "temp"){
                        _originalUrl = options.uploadUrl();
                    }
                    options.uploadUrl = function(){
                        return _originalUrl + "/" + (value ? value : "noUser");
                    };
                }
                if (name === 'redirect') {
                    redirect = value;
